          ...
          <div>
            <div className="box_header">
              <div style={{ padding: "5px 0px" }}>
                <i className="fa-solid fa-comments mx-2"></i>&emsp; Feedback List
              </div>
            </div>
            <div>
                        ...
                        return (
                          <tr key={idx}>
                            ...
                            <td className="desc feed-desc">
                              ...
                              <div>
                                {elem.mobile ? `Mobile: ${elem.mobile}` : null}
                              </div>
                              <div>
                            ...
                            <td>
                              {elem.status === "Pending" ? (
                                <i className="fa-solid fa-clock fa-2xl text-warning" style={{marginTop:'50px'}}></i>
                              ) : (
                                <i className="fa-solid fa-circle-check fa-2xl text-success " style={{marginTop:'50px'}}></i>
                              )}
                            </td>
                            <td>
                              <button className="btn btn-primary" style={{marginTop:'30px'}} onClick={()=>handleToggle(idx)}>
                                {elem.status === "Pending" ? 'Mark as Resolved' : 'Resolved'}
                              </button>
                            </td>
                          </tr>
                        );
